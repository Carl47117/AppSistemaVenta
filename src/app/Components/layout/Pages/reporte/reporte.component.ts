...
export class ReporteComponent implements OnInit {
  ...
  buscarVentas() {
    const _fechaInicio =
      this.formularioFiltro.value.fechaInicio.format('DD/MM/YYYY');
    const _fechaFin = this.formularioFiltro.value.fechaFin.format('DD/MM/YYYY');
    /*
